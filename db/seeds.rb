...
Equipment.create!(name: 'shied', hand_slot: 1, dodge: 25)
...
Equipment.create!(name: 'plate armor', body_slot: 1, toughness: 25, speed: -15)
Equipment.create!(name: 'medium armor', body_slot: 1, toughness: 15, speed: -5)
Equipment.create!(name: 'leather armor', body_slot: 1, toughness: 5, dodge: 5)